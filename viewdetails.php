            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
				  ...
				  <li><a href="addbus.php">Register</a></li>
                  <li><a href="addbus.php">Add the bus</a></li>
				    <li><a href="admindel.php">Delete the bus</a></li>
					<li class="active"><a href="viewdetails.php">View the details</a></li>
					<li><a href="chat.php">Track the bus</a></li>
                  <li class="dropdown">
